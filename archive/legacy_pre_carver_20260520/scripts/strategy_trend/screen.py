...
def _trend_story_fields(df: pd.DataFrame, *, direction: str) -> dict:
...
def build_trend_universe(
    *,
    ...
    for info in symbols:
        ...
        story_fields = _trend_story_fields(df, direction=direction)
        trend_rows.append(
            {
                "symbol": symbol,
                "name": str(info["name"]),
                ...
                "phase1_story_budget_margin_pct": story_fields["trend_story_budget_margin_pct"],
